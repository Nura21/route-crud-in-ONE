...
@section('process', __('app.buttons.edit').' '.__('app.menus.mempelai_wanita'))
@section('main')
    <div class="wrapper">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <form action="{{ url(strtolower(__('app.menus.mempelai_wanita')).'s/'.$field->id) }}" method="POST" enctype="multipart/form-data">
                      @method('patch')
                      @csrf
