...
@section('process', __('app.buttons.add').' '.__('app.menus.paket'))
@section('main')
    <div class="wrapper">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <form action="{{ url(strtolower(__('app.menus.paket')).'s') }}" method="POST">
                      @csrf
                      <x-input type="{{ __('app.fields.text') }}" name="{{ __('app.fields.type') }}" placeholder="{{ __('app.fields.type') }}" class="form-control" classForm="form-group" value="{{ old(__('app.fields.type')) }}"/>

                      <x-input type="number" name="{{ __('app.fields.price') }}" placeholder="{{ __('app.fields.price') }}" class="form-control" classForm="form-group" value="{{ old(__('app.fields.price')) }}"/>

                      <div class="form-group">
                        <button type="button" class="btn btn-default" onClick="addBenefit()">Add+</button>
                      </div>

                      <x-input type="{{ __('app.fields.text') }}" name="{{ __('app.fields.benefit') }}[]" placeholder="{{ __('app.fields.benefit') }}" class="form-control" classForm="form-group" value="{{ old(__('app.fields.benefit')) }}"/>
